...
export const metadata: Metadata = {
  ...
  description: "How this Engram instance handles account, source, and Gmail data.",
};
  ...
  return (
    <main className="publicPage legalPage">
      ...
      <article className="legalContent">
        ...
        <p>
          This policy describes this self-hosted Engram service, operated by its instance administrator. It
        ...
        <p>
          Engram stores the notes, documents, memories, and account details
        ...
        <p>
          If you connect Gmail, Engram requests only the
        ...
        <p>
          The message text is stored as a Engram source document so you can
          search it and, if enabled, analyze it into suggested memories for
          review. Engram does not sell Google user data, use it for
          ...
          instance; its default model service runs alongside Engram.
        </p>
        <p>
          Engram stores the Google refresh token encrypted in its database
          using AES-256-GCM. The token is used to obtain access tokens for
          scheduled read-only syncs and is not returned by the Engram API.
        </p>

        <h2>Storage, access, and sharing</h2>
        <p>
          This instance stores application data in its configured database and
          object storage on the Engram deployment. The instance
          ...
          to operate this Engram instance.
        </p>
        ...
        <p>
          ...
          into Engram or memories you accepted from them. Remove those
          source documents and memories in Engram, and contact the instance
          ...
          retention period ends. You can also review or revoke Engram's
        ...
        <p>
          ...
          security; protect your Engram account and contact the instance
        ...
        <p>
          ...
          change. For questions or deletion requests, contact the Engram
          instance administrator using the support address shown on the Google
          OAuth consent screen.
        </p>
        <p>
          Engram's use of information received from Google APIs adheres to
          the Google API Services User Data Policy, including the Limited Use
          requirements.
        </p>
      </article>
      <footer className="publicFooter"><Link href="/about">Engram</Link><Link href="/terms">Terms of service</Link></footer>
    </main>
  );
}
